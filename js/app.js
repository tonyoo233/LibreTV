// 全局变量
let selectedAPIs = JSON.parse(localStorage.getItem('selectedAPIs') || '["heimuer", "ruyi", "bfzy", "tyyszy", "ffzy", "zy360", "iqiyi", "wolong", "jisu", "dbzy", "ftys", "ysgc", "qqzy"]'); // 默认选中资源
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    if (!localStorage.getItem('hasInitializedDefaults')) {
         // 默认选中资源
        selectedAPIs = ["heimuer", "ruyi", "bfzy", "tyyszy", "ffzy", "zy360", "iqiyi", "wolong", "jisu", "dbzy", "ftys", "ysgc", "qqzy"];
